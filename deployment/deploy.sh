...
daphne -b 0.0.0.0 -p 8001 django_server.asgi:channel_layer & python manage.py runworker & python manage.py runworker & uwsgi --socket :8000 --module django_server.wsgi 
