...
#### 1. Step One - Downloading Virtual Box
...
#### 2. Step Two - Starting installation
...
#### 1. Step One - Downloading the Ubuntu disk image (.iso file)
...
#### 2. Step Two - Creating the New Virtual Machine
...
#### 3. Step Three - Setting Base Memory (RAM)
...
#### 7. Step Seven - Disk File Location and Hard Drive Size
...
#### 8. Step Eight - Create the Virtual Hard Drive
...
#### 9. Step Nine - Adding the Downloaded Ubuntu Disk Image
...
#### 10. Step Ten - Downloading Ubuntu onto your virtual machine
