  ...
  return (
    <DocsContent>
      ...
      <div className="ui success compact message">
        ...
        {" "}
        <a
          href="https://gist.github.com/tocttou/ceae739c32855a657546aa8420c4bbb7"
        >
          gist
        </a>
        .
        ...
        <li>
          ...
          <ul className="list">
            <li>
              ...
              <ul className="list">
                <li>
                  Returns an array of local paths to the uploaded images. This is the
                  {" "}
                ...
                <li>
                  <div className="ui success compact message">
                    ...
                    {" "}
                    <a
                      href="https://gist.github.com/tocttou/1fd770483294fab36cd17a163e21c4c9"
                    >
                      gist
                    </a>
                    .
              ...
              <ul className="list">
                ...
                <li>
                  <div className="ui success compact message">
                    ...
                    {" "}
                    <a
                      href="https://gist.github.com/AvaisP/85b74c1a76c79bae0003c0a685b7eb95"
                    >
                      gist
                    </a>
                    .
