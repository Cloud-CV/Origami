    ...
    if (this.state.showOutput) {
      return (
        <div className="ui very relaxed stackable centered grid">
                ...
                <div className="ui warning message">
                  <div className="header">
                    <h1>
                      You must
                      {" "}
                      <Link to="/gettingstarted/configuration">configure </Link>
                      the application before first use!
                    </h1>
                  </div>
            ...
            <div className="two column stretched row">
              ...
              <div className="column center aligned grid">
                ...
                <div className="ui fluid small segment">
                  ...
                  <Link
                    className="ui ribbon label raised fluid padded text container segment"
                    to={this.props.login ? "/ngh/user" : "/"}
                    onClick={this.useLocalDeploymentLogin}
                    style={{ textDecoration: "none", color: "inherit" }}
                  >
                    <i className="large rocket middle aligned icon" />
                    {" "}
                    Create A Demo
                  </Link>
                  <br /><br />
          ...
          {this.state.cloudCVDemos.length > 0 &&
            <div
              className="ui fluid row padded grid"
              style={{
                color: grey900,
                fontSize: "x-large",
                minWidth: "80vw"
          ...
          {this.state.isCloudCV &&
            ...
            >
              ...
              <div className="ui three wide column">
                <img
                  className="ui  middle alignedsmall image"
            ...
            <div className="ui ten wide column grid">
              <div className="ui row">
                ...
                <div className="eight wide right floated column">
                  <h4 className="ui inverted header" style={{ color: blue100 }}>
